                  ...
                  <div className="card">
                    <div className="card__body">
                      ...
                      <p>
                        ...
                        This pathway is intended for researchers, students, and practitioners
                      ...
                      >
                        Learn More & Apply as a Community Partner
                      </Link>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="card">
                    <div className="card__body">
                      ...
                      <p>
                        ...
                        Collaborators may participate in coordinated research efforts,
                        structured projects, and formal partnerships.
                      </p>
                      <p style={{ fontSize: '0.9rem', opacity: 0.8 }}>
                      ...
                      <Link
                        ...
                        style={{ marginTop: '1rem' }}
                      >
                        Learn More & Apply as a Collaborator
                      </Link>
                    </div>
                  </div>
                </div>
